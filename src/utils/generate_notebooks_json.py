...
def create_notebook_json(filename, title, plot_codes):
    cells = []
    ...
    print(f"Generated {filename} with {len(plot_codes)} visualizations using raw JSON.")
...
def main():
    ...
    create_notebook_json('EDA_Infrastructure.ipynb', 'Infrastructure Project Finance EDA', infra_plots)
    create_notebook_json('EDA_Macro.ipynb', 'Macroeconomic & Sovereign Risk EDA', macro_plots)
    create_notebook_json('EDA_Satellite.ipynb', 'Satellite Imagery & Construction Tracking EDA', sat_plots)
